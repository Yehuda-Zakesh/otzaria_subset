...
הפרסום הוא **EXE יחיד**, בערך 9MB. בלחיצה הראשונה הוא פורש תיקייה
אחת (`OtzariaSubset`) לצדו ומפעיל את התוכנה; בכל לחיצה אחרת הוא רק
מפעיל אותה. אין מתקין, אין Program Files, אין רישום ב-Windows, אין
הסרה ואין UAC. זו אינה רק נוחות: בלי הרשאות מנהל **העדכון העצמי
...
ה-stub רק מעתיק בתים לקובץ זמני, מריץ אותו ומפעיל.
